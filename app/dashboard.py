"""M8: Streamlit dashboard -- bestiary explorer, LV model findings, 5e -> Shadowdark converter.
...
tab_explorer, tab_model, tab_converter = st.tabs(
    ["Bestiary Explorer", "LV Model Findings", "5e -> Shadowdark Converter"]
)
